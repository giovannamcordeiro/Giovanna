...
class Game:
    ...
    def show_menu(self):
        ...
        if self.death_count == 0:
            draw_message_components("Press any key to start", self.screen)
        else:
            draw_message_components("Press any key to restart", self.screen, pos_y_center=half_screen_height + 140)
            draw_message_components(
